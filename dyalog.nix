...
let
  dyalogLibPath = lib.makeLibraryPath
    (with xorg; [ stdenv.cc.cc.lib glibc libiodbc ncurses5 ]);
in stdenv.mkDerivation rec {
  src = fetchurl {
    url =
      "https://www.dyalog.com/uploads/php/download.dyalog.com/download.php?file=${shortVersion}/linux_64_${version}_unicode.x86_64.deb";
    sha256 = "sha256-W2CbsXez5uPTnM5mGB1tMhsVCKiD8ZomFQi1nkZJKw8=";
  };
